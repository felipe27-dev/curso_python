...
def encontrar():
    ...
    for lista in lista_de_listas_de_inteiros:
        numero_duplicado_encontrado = -1
        numeros_checados.clear()
        
        for numero in lista:
            if numero in numeros_checados:
                numero_duplicado_encontrado = numero
                break
            numeros_checados.add(numero)
            
        lista_encontrados.append(numero_duplicado_encontrado)
        
    return lista_encontrados

numeros_encontrados = encontrar()
